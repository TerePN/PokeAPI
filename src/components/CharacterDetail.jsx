        ...
        <div className="info--sectionDiv" >
          ...
          <div className="stats">
            ...
            <div className="stats--bar">
              <div
                className="bar--porc"
                style={{ width: `${parseInt(pokemon.stats?.[0].base_stat) / 150 * 100}%` }} >
              </div>
            </div>
            ...
            <div className="stats--bar">
              <div
                className="bar--porc"
                style={{ width: `${parseInt(pokemon.stats?.[1].base_stat) / 150 * 100}%` }} >
              </div>
            </div>
            ...
            <div className="stats--bar">
              <div
                className="bar--porc"
                style={{ width: `${parseInt(pokemon.stats?.[2].base_stat) / 150 * 100}%` }} >
              </div>
            </div>
